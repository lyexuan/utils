# [1900年至2100年公历、农历互转Js代码](https://blog.jjonline.cn/userInterFace/173.html)
...
在网络中找了找相关的素材资料，要么老旧、要么有稍许错误，又把我搞烦了，遂自己写了一个可查询、互转1900年至2100年区间农历与公历的javascript库；本库所有农历数据来源于香港天文台（地址：https://data.weather.gov.hk/gts/time/conversion1_text_c.htm）；本来想找紫金山天文台的数据的，结果硬是没找着有200年区间的农历数据的网页。
